...
const messages = [
  ...
  { role: 'assistant', content: [{ type: 'text', text: 'answer', textSignature: 'answer-signature' }, { type: 'thinking', thinking: 'reason', thinkingSignature: 'thinking-signature', redacted: false }, { type: 'toolCall', id: 'call', name: 'tool', arguments: { nested: true }, thoughtSignature: 'thought-signature' }], api: 'openai-responses', provider: 'openai', model: 'model', responseModel: 'response-model', responseId: 'response-id', diagnostics: [{ type: 'provider-warning', timestamp: at(4).getTime(), error: { message: 'warning', name: 'ProviderError', stack: 'stack', code: 'E_PROVIDER' }, details: { retryable: false } }, { type: 'http-status', timestamp: at(4).getTime(), error: { message: 'rate limit', code: 429 } }], usage, stopReason: 'toolUse', errorMessage: '', timestamp: at(4).getTime() },
