...
export const sessionToRow = (value: AgentSession): RuntimeSessionRow => ({
  id: value.sessionId, tenant_id: value.tenantId, contexts_json: json(value.contexts, 'contexts_json'),
...
export const runToRow = (value: AgentRun): RuntimeRunRow => ({
  ...
  context_snapshot_json: json(value.contextSnapshot, 'context_snapshot_json'),
